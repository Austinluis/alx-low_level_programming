...
**Concepts**
[Pointers and arrays](https://savanna.alxafrica.com/concepts/60)
 ...
 * Return: Nothing.
 \*/
void simple\_print\_buffer(char \*buffer, unsigned int size)
{
        unsigned int i;
...
Directory: 0x07-pointers\_arrays\_strings
File: 0-memset.c
